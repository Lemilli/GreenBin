...
public class QuizLevelOne extends AppCompatActivity {
...
//    SuggestedArticlesAdapter suggestedArticlesAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_level_one);
...
//        });
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(QuizLevelOne.this, QuizMain.class);
                ...
                response -> {
                    for (int i = 0; i < response.length(); i++) {
                        try {
                            ...
                            // add only questions for level 1
                            if (level == 1)
        ...
        btn_quiz_choice1.setOnClickListener(view -> {
            ...
            if (btn_quiz_choice1.getText().toString().equals(questions.get(questionNumber).correct_answer)) {
                Toast.makeText(QuizLevelOne.this, "Correct!", Toast.LENGTH_SHORT).show();
                questionNumber++;
                NextQuestion();
            } else {
                WrongAnswer();
    ...
    private void NextQuestion() {
        // if won
        if(questionNumber == 5){
            Intent intent = new Intent(QuizLevelOne.this, QuizComplete.class);
        ...
        tv_quiz_number.setText("Question " + (questionNumber + 1) + " of 5");
...
//        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(QuizLevelOne.this);
//        alertDialogBuilder
//                .setMessage("Game Over")
//                .setCancelable(false)
//                .setPositiveButton("New Game", (dialogInterface, i) -> {
//                    startActivity(new Intent(getApplicationContext(), QuizLevelOne.class));
...
//    }
    ...
    private void WrongAnswer() {
        ...
        Toast.makeText(QuizLevelOne.this, "Wrong. Minus 10 points.", Toast.LENGTH_SHORT).show();
        wrong_answers_count++;
        NextQuestion();
    }
}