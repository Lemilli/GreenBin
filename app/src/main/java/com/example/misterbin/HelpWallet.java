...
import com.example.misterbin.adapter.HelpWalletSliderAdapter;

public class HelpWallet extends AppCompatActivity {
    ...
    private HelpWalletSliderAdapter sliderAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_help_wallet);
        ...
        sliderAdapter = new HelpWalletSliderAdapter(this);
        ...
        nextButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view)
            {
                ...
                {
                    Intent i = new Intent(HelpWallet.this, GetHelpPage.class); //back to profile page
                    startActivity(i);
                    finish();
                }
                else
