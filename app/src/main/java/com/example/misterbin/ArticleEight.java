...
public class ArticleEight extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_article_eight);

        //Data for the Top Picks Article recycler view scroll
        List<SuggestedArticlesData> suggestedArticlesDataList = new ArrayList<>();
        suggestedArticlesDataList.add(new SuggestedArticlesData("What is Recycling?", "Fermin Koop", R.drawable.article_one_cover));
        suggestedArticlesDataList.add(new SuggestedArticlesData("The Steps of Recycling", "Fermin Koop", R.drawable.article_three_cover));
        suggestedArticlesDataList.add(new SuggestedArticlesData("Recycled Materials", "Fermin Koop", R.drawable.article_five_cover));
        suggestedArticlesDataList.add(new SuggestedArticlesData("The Future of Recycling (P1)", "RTS Blog", R.drawable.article_seven_cover));
        ...
        seeAllArticles.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ArticleEight.this, ArticlesList.class);
