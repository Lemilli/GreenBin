...
import com.example.misterbin.adapter.HelpPageSliderAdapter;

public class HelpMap extends AppCompatActivity {
    ...
    private HelpPageSliderAdapter sliderAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sliderAdapter = new HelpPageSliderAdapter(this);
        ...
        nextButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view)
            {
                ...
                {
                    Intent i = new Intent(HelpMap.this, GetHelpPage.class); //back to profile page
                    startActivity(i);
                    finish();
                }
                else
