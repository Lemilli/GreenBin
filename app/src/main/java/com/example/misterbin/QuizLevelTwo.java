...
public class QuizLevelTwo extends AppCompatActivity {
...
//    SuggestedArticlesAdapter suggestedArticlesAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_level_two);
...
//        });
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(QuizLevelTwo.this, QuizMain.class);
                ...
                response -> {
                    for (int i = 0; i < response.length(); i++) {
                        try {
                            ...
                            // add only questions for level 2
                            if (level == 2)
        ...
        btn_quiz_choice1.setOnClickListener(view -> {
            ...
            if (btn_quiz_choice1.getText().toString().equals(questions.get(questionNumber).correct_answer)) {
                Toast.makeText(QuizLevelTwo.this, "Correct!", Toast.LENGTH_SHORT).show();
                questionNumber++;
                NextQuestion();
            } else {
                WrongAnswer();
    ...
    private void NextQuestion() {
        ...
        if (questionNumber == 10) {
            Intent intent = new Intent(QuizLevelTwo.this, QuizComplete.class);
        ...
        tv_quiz_number.setText("Question " + (questionNumber + 1) + " of 10");
    ...
    private void WrongAnswer() {
        ...
        Toast.makeText(QuizLevelTwo.this, "Wrong. Minus 10 points.", Toast.LENGTH_SHORT).show();
        wrong_answers_count++;
        NextQuestion();
    }
}